...
npm run e2e        # JSON-RPC session: 68 tools, 13 resources, 5 prompts: PASS
```
...
npm run e2e        # "E2E PASS" — 68 tools, 13 resources, 5 prompts
```
...
| Full JSON-RPC surface: 68 tools, 13 resources, 5 prompts | `npm run e2e` |
