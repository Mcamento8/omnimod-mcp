...
npm run e2e        # JSON-RPC session: 66 tools, 13 resources, 5 prompts: PASS
```
...
npm run e2e        # "E2E PASS" — 66 tools, 13 resources, 5 prompts
```
...
| Full JSON-RPC surface: 66 tools, 13 resources, 5 prompts | `npm run e2e` |
