  ...
  return [
    ...
    },
    {
      ...
      contains:
        ...
        "When you DO have to author one, omni_3d_template gives a correct starting shell (outward winding, base on y=0, 1 unit = 1 block, o-groups for moving parts) and omni_3d_validate parses your OBJ the way the engine does and reports the defects that only appear in game — concave faces fan-triangulation tears apart, degenerate/duplicate triangles, inconsistent winding, a texture bound with no UVs, a base not at y=0, the triangle budget. The full standard is agent/14_AUTHORING_3D_MODELS.md.",
    },
    {
